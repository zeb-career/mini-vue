...
function createRenderer(options) {
    const { createElement: hostCreateElemnet, patchProp: hostPatchProp, insert: hostInsert, } = options;
    ...
    function procoessFragment(vnode, container, parentComponent) {
        mountChildren(vnode, container, parentComponent);
    }
    function procoessText(vnode, container) {
