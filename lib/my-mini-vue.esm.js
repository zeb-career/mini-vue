...
const readonlyHandlers = {
    ...
    set(target, key, value) {
        console.warn(`key:${key},set ${value} fail`, target);
        return true;
    }
};
...
function createRenderer(options) {
    const { createElement: hostCreateElemnet, patchProp: hostPatchProp, insert: hostInsert, remove: hostRemove, setElementText: hostSetElementText } = options;
    ...
    function procoessFragment(n1, n2, container, parentComponent) {
        mountChildren(n2.children, container, parentComponent);
    }
    function procoessText(n1, n2, container) {
        const { children } = n2;
    ...
    function patchElement(n1, n2, container, parentComponent) {
        ...
        ptachChildren(n1, n2, el, parentComponent);
        patchProps(el, oldProps, newProps);
    }
    function ptachChildren(n1, n2, container, parentComponent) {
